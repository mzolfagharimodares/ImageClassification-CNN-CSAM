...
model = ResidualNet("Tiny_ImageNet", depth, num_classes).to(device)
...
import numpy as np
path = load_img('/content/Tiny_ImageNet/train/n02124075/n02124075_18.JPEG')
...
# plot feature maps of the image
plt.rcParams['font.family'] = 'serif'
plt.rcParams['font.serif'] = ['times'] + plt.rcParams['font.serif']
